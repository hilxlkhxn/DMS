...
<body>
    ...
    <section class="attendance-table">
        <div class="container">
            <h2>MBA - Islamic Banking & Finance </h2>
            ...
            <table>
                ...
                <tbody>
                <?php 
                    $query = "SELECT * FROM mba_ibf_attendance";
    ...
    <!-- Modal -->
    <form action="insert_mba_ibf_at.php" method="post">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <input type="submit" class="btn btn-success" name="add_ibf_students" value="ADD">
      </div>
    </div>
  </div>
</div>
